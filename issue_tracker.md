...
| **Proposal Guide** | Rework floating widget copy to pitch recommendations and remove personal names | Medium | `[x]` Resolved | Reworked copy to serve as an "Enhancement Guide & Concept Highlights", removing names. Added dynamic collapsed-state button text ("Click to learn about your site upgrades") to prompt action. |
