...
<head>
  ...
  <style>
    ...
    .subpage-hero {{
      background: linear-gradient(135deg, var(--color-primary-navy) 0%, #0c3552 100%);
...
def build_programs():
    ...
    prog_html += """
  <main id="main-content">
    <section class="subpage-hero" style="background: linear-gradient(135deg, #856a29 0%, #523f11 100%);">
      <div class="container">
...
def build_rates_insurance():
    ...
    rates_html += f"""
  <main id="main-content">
    <section class="subpage-hero" style="background: linear-gradient(135deg, #1b3d54 0%, #0f2535 100%);">
      <div class="container">
...
def build_contact():
    ...
    contact_html += """
  <main id="main-content">
    <section class="subpage-hero" style="background: linear-gradient(135deg, var(--color-primary-navy) 0%, #163e5d 100%);">
      <div class="container">
